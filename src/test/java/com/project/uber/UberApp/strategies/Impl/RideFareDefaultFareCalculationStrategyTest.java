...
class RideFareDefaultFareCalculationStrategyTest {
    ...
    void testCalculateFare_Success() {
        ...
        double mockDistance = 10.5; // Let's pretend the distance is 10.5 km
        ...
        // Assert
        double expectedFare = mockDistance * RideFareCalculationStrategy.RIDE_FARE_MULTIPLIER;
